...
export default function Navbar() {
  return (
    <div>
       <marquee className='text-center text-3xl bg-yellow-500 text-white py-2'> %%   Free shipping on all orders   %%  </marquee>
      <nav className='flex items-center justify-between bg-white shadow-xl'>
        ...
        <div className='flex items-center gap-8 px-5'>
          <button className='px-5 py-2 rounded hover:text-black border border-green-500 hover:bg-green-500 shadow-2xl text-green-500'> Log In </button>
